...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.particle_size_definition = QtWidgets.QComboBox(self.formLayoutWidget)
        self.particle_size_definition.setObjectName("particle_size_definition")
        self.particle_size_definition.addItem("")
        self.particle_size_definition.addItem("")
        self.particle_size_definition.addItem("")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.particle_size_definition)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.laser_width)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.laser_shape_factor)
        ...
        self.peak_find.addItem("")
        self.peak_find.addItem("")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.peak_find)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.bit_depth)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.particle_count)
        self.pattern_mean = QtWidgets.QDoubleSpinBox(self.formLayoutWidget)
        self.pattern_mean.setEnabled(False)
        self.pattern_mean.setObjectName("pattern_mean")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.pattern_mean)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_19.setToolTip(_translate("MainWindow", "<html><head/><body><p>Definition of what a image particle size is. All definitions are based on where a value of the gauss distribution is reached. &quot;e2&quot; is where the intensity reaches e-2. &quot;I/2&quot; uses half the intensity as the size definition, &quot;2sigma&quot; defines that the particle diameter is 2 sigma of the distribution.</p></body></html>"))
        self.label_19.setText(_translate("MainWindow", "psize definition"))
        self.particle_size_definition.setItemText(0, _translate("MainWindow", "e2"))
        self.particle_size_definition.setItemText(1, _translate("MainWindow", "I2"))
        self.particle_size_definition.setItemText(2, _translate("MainWindow", "2sigma"))
